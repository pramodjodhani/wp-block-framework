...
/* harmony import */ var _hooks_useClickOutside__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../hooks/useClickOutside */ "./src/hooks/useClickOutside.js");
...
const ColorField = _ref => {
  ...
  const popover = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const [isOpen, toggle] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const close = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => toggle(false), []);
  (0,_hooks_useClickOutside__WEBPACK_IMPORTED_MODULE_2__["default"])(popover, close);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wpbf-color-picker"
    ...
    className: "wpbf-color-picker__popover",
    ref: popover
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_colorful__WEBPACK_IMPORTED_MODULE_3__.HexColorPicker, {
    color: value,
    onChange: onChange
  })));
};
...
function EditorField(_ref) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    setTimeout(() => {
      wp.editor.initialize(id, { ...wp.editor.getDefaultSettings()
      });
    }, 1000);
  }, []);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EditorField);
  ...
  singleField: function (field, props, blockProps, parentField) {
    ...
    switch (field.type) {
      ...
      case 'group':
        ...
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fields_GroupField__WEBPACK_IMPORTED_MODULE_4__["default"], {
          field: field,
          value: value,
          key: field.id,
...
var blockFrameworkMain = {
  ...
  edit: (block_id, props, fieldData) => {
    ...
    }, blockFrameworkMain.get_fields_lists(fieldData, props, blockProps, true))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToolbarGroup, null, 'edit' === viewMode ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToolbarButton, {
